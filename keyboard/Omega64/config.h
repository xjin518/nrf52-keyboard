...
#define MANUFACTURER "LyonsCM" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "lyonscm70" /* 硬件名词，用于蓝牙显示 */
...
//#define UART_DET 18 // UART 检测引脚，若此脚被拉低，则说明USB正在工作。若不配置则使用RX口作为检测引脚
...
static const uint8_t row_pin_array[MATRIX_ROWS] = { 3, 31, 29, 26, 4 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 20, 22, 23, 24, 5, 6, 7, 8, 9, 10, 11, 12, 16, 15, 14, 13 };
